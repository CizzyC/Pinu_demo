...
| 小游戏验证 | 以 Bingo Challenge 验证每日挑战、轻复习、XP 激励和 Pinu 风格图文教学 |
...
- Bingo Challenge 当前更适合定位为每日词汇挑战，不应作为每个 Unit 的强制复习环节；试玩模式可承接首次体验和投放，但不计入正式学习正确率和掌握度。
...
| `../Pinu_game/docs/pinu-bingo-decisions-and-collaboration.md` | Bingo Challenge 当前决策、MVP 边界、词库规则、教学引导、评审风险和协作方式沉淀 |
...
- 6.29 Bingo Challenge：已形成「每日词汇挑战」定位，收敛 MVP 边界，补充目标分、词库抽题、局内教学引导、流程图和 Pinu 风格图文教学方案。
